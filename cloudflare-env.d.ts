/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: caa5eb104cce696251a79fa50c1bf66f)
// Runtime types generated with workerd@1.20260623.1 2026-06-24 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* pemahaman-app */;
}
